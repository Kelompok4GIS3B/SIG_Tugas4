...
folium.Marker([-6.154400, 106.574181], popup='Pecel Lele Depot Lusi').add_to(m)
folium.Marker([-6.154656, 106.571472], popup='Warung Ibu Iman').add_to(m)
folium.Marker([-6.155276, 106.571717], popup='RM Gudeg Yogya Bu Karman').add_to(m)
folium.Marker([-6.154735, 106.571939], popup='Sate padang Uda Buyung').add_to(m)
folium.Marker([-6.155124, 106.571253], popup='SYDNEY FRIED CHICKEN').add_to(m)
folium.Marker([-6.154914, 106.571722], popup='ATM Maybank').add_to(m)
folium.Marker([-6.154942, 106.572099], popup='Chandras Rental Mobil').add_to(m)
folium.Marker([-6.154742, 106.573228], popup='Ayam Kalasan Prima hj Sunety').add_to(m)
folium.Marker([-6.154565, 106.574372], popup='Es Kopyor Mekar Abadi').add_to(m)
folium.Marker([-6.154869, 106.572666], popup='Rendang ngehe').add_to(m)
