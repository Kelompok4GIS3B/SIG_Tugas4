import folium
	...
	folium.Marker([-6.185059, 106.641595], popup='<i>Mangs Cafe and Lounge</i>').add_to(m)
	...
	folium.Marker([-6.194506, 106.584156], popup='<i>MTs Mathlaul Anwar</i>').add_to(m)
...
disimpan(n,'5.html')
disimpan(m,'6.html')
>>>>>>> d0060275fed5345122c51cd917b373703e1f996f
